...
The techniques include: the support vector machine, the logistic regression and the K-Nearest Neighbour. Our second contribution is to propose several possible parallel % SEVERAL ? JE PENSE QU'ON AURA LE TEMPS QUE POUR UNE SEULE
...
implementation. % PROBLEME ICI ON N'AURA PAS LE TEMPS DE TESTER PLUSIEURS IMPLEMENTATIONS
